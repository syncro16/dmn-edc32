...
#define PRODUCT_NAME "dmn-edc for stm32f334 rel.201710"

#define FLASH_PAGE_SZ 2048 // 32 pages, 64kB total. Max program size 57kB. Modify linker script not to overwrite whole flash when uploading -> FLASH (rx)      : ORIGIN = 0x8000000, LENGTH = 60K 
#define FLASH_OFFSET_SETTINGS (0x8000000 + FLASH_PAGE_SZ * 29) // 4kB for settings
#define FLASH_OFFSET_DTC (0x8000000 + FLASH_PAGE_SZ * 31) // 2kB for diagnostic trouble codes 
